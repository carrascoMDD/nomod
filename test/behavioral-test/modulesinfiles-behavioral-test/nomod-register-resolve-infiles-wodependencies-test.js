...
describe( ModuleName + " " + ModulePackages + " " + ComponentName, function () {
    ...
    it("resolves a module without dependencies given its full name", function () {
        ...
        var aFullName01 = nomod.fComputeFullName( "nomod-test-instances", "test/behavioral-test/modulefiles-wodependencies", "module01wodeps");
    ...
    it("resolves two distinct modules without dependencies  given their full name", function () {
        ...
        var aFullName01 = nomod.fComputeFullName( "nomod-test-instances", "test/behavioral-test/modulefiles-wodependencies", "module01wodeps");
        var aFullName02 = nomod.fComputeFullName( "nomod-test-instances", "test/behavioral-test/modulefiles-wodependencies", "module02wodeps");
